...
const createALineup = () => {
 return (
  <section
   id='createALineup'
   className='bg-dark pt-12 xs:pt-20 sm:pt-20 pb-10 sm:pb-20 px-5 sm:px-10 over-tokens '
  >
   {/* right pipe */}
   ...
   {/* Bottom pipe */}
   <div className='absolute z-50 bottom-0 left-0 right-0 xl:right-20 xl:rounded-tl-2xl h-20 bg-medium'>
   <div className='absolute z-50 bottom-8 w-full left-8 right-0 xl:right-20 h-3 bg-light pipe-shine'></div>
   </div>   
   ...
   {/* Content */}
   <div className='flex flex-col md:flex-row items-center justify-start lg:justify-center space-x-0 sm:space-x-8 lg:space-x-16  space-y-10 md:space-y-0 container max-w-6xl mx-auto pb-32 sm:pb-20 md:pb-0'>
   ...
   <div className='absolute w-5/6 xs:w-2/3 sm:w-2/5 pl-12 md:w-1/4 lg:w-1/4 xl:w-1/5 bottom-56 right-24 md:right-28 md:bottom-56 xl:right-60'>
