...
const pickAGame = () => {
 return (
  <section
   id='pickAGame'
   className='bg-dark pt-28 pb-10 sm:pb-20 px-5 sm:px-10 over-tokens '
  >
   {/* top pipe */}
...
'
   ...
   {/* Bottom pipe */}
   <div className='absolute z-50 bottom-0 left-0 right-0 xl:right-20  h-20 bg-medium xl:border-r-8 xl:border-primary rounded-tl-2xl'></div>
